  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center">
      ...
      <div className="md:col-span-5 hidden md:flex items-center justify-center">
        <QuestionSideImage
          src="/assets/placeholders/goal-weight.webp"
          alt="Goal weight composition scale calibration"
          fileName="placeholders/goal-weight.webp"
          placeholderText={locale === "pt-br" ? "Balança inteligente de bioimpedância" : "Smart bioimpedance body scale"}
          aiPrompt="A high tech 3D glowing body weight smart scale indicating digital fat percentage levels, brand teal and lime outlines, dark room background."
          fallbackSvg={
