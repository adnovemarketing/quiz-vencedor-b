...
export function StepAgeSelection({ onNext }: StepProps) {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <QuestionHeroImage
        src="/assets/placeholders/age-recovery-curve.webp"
        alt="Age Recovery Curve metabolism calibration"
        fileName="placeholders/age-recovery-curve.webp"
        placeholderText={locale === "pt-br" ? "Curva biológica de recuperação por idade" : "Biological recovery curve by age"}
        aiPrompt="A sleek diagram illustrating metabolism, heart rate, and biological recovery zones mapped to age metrics, futuristic styling, brand lime accents, black background."
        fallbackSvg={
