...
import { ProductMockup } from "@/components/ui/ImageWrapper";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center">
      ...
      <div className="md:col-span-5 hidden md:flex items-center justify-center">
        <ProductMockup
          src="/assets/mockups/email-mockup.webp"
          alt="Ebook Report phone mockup preview"
          fileName="mockups/email-mockup.webp"
          placeholderText={locale === "pt-br" ? "Visualização do relatório em PDF no celular" : "PDF Report smartphone preview mockup"}
          aiPrompt="A high quality realistic photo of a modern smartphone showing the Treadmill Method fitness app UI, with custom weights graph on screen, clean dark aesthetic."
          fallbackSvg={
