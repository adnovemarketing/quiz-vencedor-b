...
export function StepReportProjection({ onNext }: StepProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center">
      ...
      <div className="md:col-span-5 flex flex-col bg-zinc-950/40 rounded-2xl border border-zinc-900/60 overflow-hidden group select-none mt-4 md:mt-0">
        ...
        <div className="p-4 flex flex-col gap-1.5 border-t border-zinc-900 bg-zinc-900/20">
