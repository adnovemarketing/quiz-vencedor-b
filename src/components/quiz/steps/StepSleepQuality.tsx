  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center">
      ...
      <div className="md:col-span-5 hidden md:flex items-center justify-center">
        <QuestionSideImage
          src="/assets/images/sleep.webp"
          alt="Sleep cycle restoration"
          fileName="images/sleep.webp"
          placeholderText={locale === "pt-br" ? "Pessoa dormindo calmamente" : "Person sleeping restfully"}
          aiPrompt="A dark cozy bedroom scene, clean, minimalist fitness style, showing a person sleeping restfully in bed, soft moonlight coming through the window, cyan and lime soft lighting accentuation, photorealistic, 8k resolution."
          fallbackSvg={
