...
import { TransitionImage } from "@/components/ui/ImageWrapper";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center">
      ...
      <div className="md:col-span-6 flex items-center justify-center">
        <TransitionImage
          src="/assets/images/progress-graph.webp"
          alt="Calorie burn comparison"
          fileName="images/progress-graph.webp"
          placeholderText={locale === "pt-br" ? "Gráfico comparativo de queima calórica" : "Calorie oxidation comparative chart"}
          aiPrompt="Minimalist high fidelity vector line graph comparing flat walking metabolism to incline walking calorie expenditure spikes over 30 minutes, brand lime neon, glowing dark ui style."
          fallbackSvg={
            <div className="w-full h-full flex flex-col p-5 justify-center select-none relative text-center">
