  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center">
      ...
      <div className="md:col-span-5 hidden md:flex items-center justify-center">
        <QuestionSideImage
          src="/assets/placeholders/incline-profile.webp"
          alt="Treadmill Incline Profile"
          fileName="placeholders/incline-profile.webp"
          placeholderText={locale === "pt-br" ? "Mecânica de inclinação da esteira" : "Treadmill incline deck schematic"}
          aiPrompt="Minimalist high-tech schematic diagram of a treadmill showing adjustable incline deck angles, highlighted in brand lime, glowing accent lines, dark styling."
          fallbackSvg={
