...
export function StepCardioLevel({ onNext }: StepProps) {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <QuestionHeroImage
        src="/assets/placeholders/cardio-level-curve.webp"
        alt="Heart Rate Cardio Zones metabolism calibration"
        fileName="placeholders/cardio-level-curve.webp"
        placeholderText={locale === "pt-br" ? "Curva de zonas cardíacas de esforço" : "Heart rate cardio zones curve"}
        aiPrompt="A premium 3D design of a human heart or electrocardiogram line showing active effort levels in brand lime and teal, fitness concept background, high resolution."
        fallbackSvg={
