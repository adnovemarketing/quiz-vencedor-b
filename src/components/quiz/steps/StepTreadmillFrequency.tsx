  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center">
      ...
      <div className="md:col-span-5 hidden md:flex items-center justify-center">
        <QuestionSideImage
          src="/assets/placeholders/weekly-frequency.webp"
          alt="Treadmill training calendar schedule"
          fileName="placeholders/weekly-frequency.webp"
          placeholderText={locale === "pt-br" ? "Calendário semanal de treinos na esteira" : "Weekly treadmill training calendar"}
          aiPrompt="A premium 3D design of a calendar with active training days highlighted in brand teal and lime, modern gym theme background, high resolution."
          fallbackSvg={
