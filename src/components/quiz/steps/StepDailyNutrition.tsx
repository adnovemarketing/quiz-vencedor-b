  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center">
      ...
      <div className="md:col-span-5 hidden md:flex items-center justify-center">
        <QuestionSideImage
          src="/assets/images/healthy-food.webp"
          alt="Healthy food timing nutrition macros"
          fileName="images/healthy-food.webp"
          placeholderText={locale === "pt-br" ? "Prato de refeição saudável equilibrada" : "Plate of balanced healthy macros nutrition"}
          aiPrompt="High fidelity premium photo of a healthy meal plate with avocado, salmon, and leafy greens, dynamic clean fitness presentation, transparent background, photorealistic."
          fallbackSvg={
