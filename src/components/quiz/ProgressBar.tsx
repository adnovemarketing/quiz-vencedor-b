...
interface ProgressBarProps {
  ...
  stepNumber?: number;    // Número sequencial exato (1-16)
  totalSteps?: number;    // Total de etapas visíveis
  onBack?: () => void;
  onForward?: () => void;
...
export function ProgressBar({
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 py-4 flex flex-col gap-2 select-none">
      {/* Contador textual de progresso */}
      {CRO_FLAGS.quizStepCounter && stepNumber !== undefined && totalSteps !== undefined && (
      ...
      {/* Linha de progresso com dots e controles */}
