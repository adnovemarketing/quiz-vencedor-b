...
import { OfferHeroImage, TestimonialPhoto, ImageWrapper } from "@/components/ui/ImageWrapper";
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-start">
            ...
            <div className="bg-zinc-900/20 border border-zinc-900 p-5 rounded-3xl flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4">
                {t.offer.testimonials.map((testi, idx) => {
                  const avatarFile = `testimonials/testimonial-0${idx + 1}.webp`;
                  return (
                    <div key={idx} className="bg-zinc-950 border border-zinc-900 p-4 rounded-2xl flex gap-3.5 items-start">
                      <TestimonialPhoto
                        src={`/assets/${avatarFile}`}
                        alt={testi.name}
                        fileName={avatarFile}
                        placeholderText={testi.name.charAt(0)}
                        aiPrompt={`Close-up portrait photography of a fit person smiling, outdoors natural lighting, fitness style, highly detailed, photorealistic.`}
                      />
          ...
          <div className="md:col-span-5 md:sticky md:top-24 flex flex-col gap-5">
            ...
            <div className="w-full flex items-center justify-center">
              <OfferHeroImage
                src="/assets/offer/offer-mockup.webp"
                alt="The Treadmill Method Complete Bundle"
                fileName="offer/offer-mockup.webp"
                placeholderText={locale === "pt-br" ? "Mockup do Ebook e aplicativo celular" : "Smartphone and Ebook bundle mockup"}
                aiPrompt="A high quality premium 3D mockup of a tablet displaying a fitness book cover and a floating smartphone next to it showing workout analytics, high resolution, dark gradient environment."
                fallbackSvg={
                  <div className="w-full h-full flex flex-col items-center justify-center p-5 select-none relative text-center">
                    <div className="absolute inset-0 bg-gradient-to-tr from-brand-lime/5 via-transparent to-brand-teal/5 opacity-85" />
            ...
            <div className="bg-zinc-900/20 border border-zinc-900 p-4.5 rounded-3xl flex gap-3.5 items-center">
              <ImageWrapper
                src="/assets/offer/badge-guarantee.svg"
                alt="30-day guarantee seal"
                fileName="offer/badge-guarantee.svg"
                placeholderText={locale === "pt-br" ? "Selo de Garantia de 30 Dias" : "30-Day Guarantee Seal"}
                aiPrompt="A premium flat security badge icon representing a 100% money back guarantee seal, vector SVG in brand teal."
                aspectRatio="1/1"
                className="w-12 h-12 rounded-full border-zinc-800 bg-zinc-900 shrink-0"
                fallbackSvg={<ShieldCheck className="w-8 h-8 text-brand-teal shrink-0" />}
              />
              <div>
